...
public class Codec {
    ...
    public void serialize(TreeNode node, List<String> list) {
        if(node == null) {
            list.add("null");
            return;
        }
    ...
    public TreeNode deserialize(String data) {
        ...
        return deserializeProcess(datas);
    }

    public TreeNode deserializeProcess(String[] datas) {
        ...
        index++;
        node.left = deserializeProcess(datas);
        index++;
        node.right = deserializeProcess(datas);
        return node;
    }
}
